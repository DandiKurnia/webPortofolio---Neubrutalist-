  ...
  return (
    <>
      ...
      <main className="w-full min-w-0 max-w-[1440px] mx-auto overflow-hidden">
        <section className="py-10 sm:py-14 md:py-18 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-16 bg-surface-container-highest relative min-h-screen">
          <div className="mb-6 sm:mb-8 md:mb-12 lg:mb-16 flex flex-col sm:flex-row items-center sm:items-center justify-center md:justify-between gap-4 md:gap-6">
            <div className="flex items-center gap-3 sm:gap-4 md:gap-6">
              <h1 className="font-headline text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black uppercase tracking-tighter bg-white brutal-border inline-block px-4 pt-2 -rotate-1 md:-rotate-2 text-center md:text-left">
                All Projects
              </h1>
              <svg
                className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 text-neon-pink hidden sm:block"
                fill="currentColor"
                viewBox="0 0 100 100"
                aria-hidden="true"
              >
            ...
            <Link
              href="/"
              className="font-mono font-bold text-xs sm:text-sm md:text-base uppercase flex items-center gap-2 bg-white brutal-border brutal-shadow px-4 py-2 sm:px-5 sm:py-3 hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none transition-all"
            >
